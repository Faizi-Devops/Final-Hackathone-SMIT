...
const Add_category = () => {
    ...
    const [daking,setDaKing]=useState<any>()
    useEffect(() => {
        onFetchCategory()
    ...
    const onFetchCategory = async () => {
        try {
            const response = await axios.get("http://localhost:8000/sub/getSub");
    ...
    const onAddCategory = async () => {
        ...
        if (name && description !== "") {
            ...
            try {
                const response = await axios.post("http://localhost:8000/sub/addSub", addCategory);
    ...
    const onDeleteHandler = async (iding: any) => {
        try {
            const response = await axios.delete(`http://localhost:8000/sub/deleteSub/${iding}`);
    ...
    //         })
    //         const response = await axios.put(`http://localhost:8000/sub/updateSub/${iding}`, update)
                        ...
                        <div className="col-lg-9 col-md-6 col-sm-12 col-xs-12" style={{ paddingTop: "30px" }}>
                            ...
                            <div className="card" style={{ width: "100%" }}  >
                                ...
                                <div className="card-body">
                                    <h6 className="card-title text-center">Subcategory</h6>
                                    <div className="row pt-3">
                                        <div className={`col-lg-3 ${styles.currentpassword}`}><p style={{ fontSize: "15px", marginBottom: "0px" }}>Select Category</p></div>
                                    ...
                                    <div className="row pt-3">
                                        <div className={`col-lg-3 ${styles.currentpassword}`}><p style={{ fontSize: "15px", marginBottom: "0px" }}>Subcategory Name</p></div>
                                        <div className="col-lg-7" style={{ marginBottom: "0px" }}>
                                            <div>
                                                <input type="text" value={name} className="form-control" placeholder="Enter Subcategory Name" onChange={alpha} style={{ height: "33px" }} />
                                            </div>
                                        </div>
                                        <div style={{ width: "94%", margin: "auto", color: "#777777" }}>
                                            <hr />
                                        ...
                                        <div className="col-lg-7">
                                            {
                                                flag ? <div>
                                                    ...
                                                    <div>
                                                        <button type="button" className="btn btn-primary" style={{ borderRadius: "30px" }} onClick={onAddCategory}>Create</button>
                            ...
                            <div className="card " style={{ width: "100%" }}  >
                                ...
                                <div className="card-body">
                                    <h6 className="card-title text-center">Manage Categories</h6>
                                     
                                    {
                                       data.length === 0 ?<div className="alert alert-warning alert-dismissible fade show" role="alert">
                                       <strong>Hii Admin! </strong>There are no sub categories for showing.
                                    ...
                                    <div className="text-center pt-2">
                                        <button type="button" style={{ borderRadius: "20px" }} className="btn btn-primary"><Link href="/Admin/See_All_Subcategories" style={{ textDecoration: "none" }}> <span style={{ color: "white" }}>See All</span></Link></button>
                                    </div>
