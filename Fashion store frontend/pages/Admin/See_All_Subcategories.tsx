        ...
        <div>
            ...
            <div className="row pt-3 mb-3">
                ...
                <div className="col-lg-6">
                    ...
                    <div className="mb-3">
                        <input type="email" className="form-control"  style={{ height: "50px", borderRadius: "30px" }} onChange={alpha} />
                    </div>
                </div>
                <div className="col-lg-3"></div>
            ...
            </div>
            {
                        ...
                        <strong>Hii Admin! </strong>There are no states for showing.
                       
                      </div>:
                      <div>
                        <marquee style={{color:"red"}}>Please search the record with subcategory name</marquee>
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h1 className="modal-title fs-5" id="exampleModalLabel">Subcategory Update</h1>
                                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div className="modal-body">
                                <div className="form-group">
                                    <label htmlFor="exampleInputEmail1" className="pb-2">Subcategory Name</label>
